  ...
  <div class="copilot-page">
    <section class="copilot-main">
      ...
      <div ref="conversationRef" class="conversation">
        ...
        <article v-if="chat.isStreaming && chat.streamingText" class="chat-message assistant">
          <div class="message-bubble">
            <p class="answer-summary streaming-answer">{{ chat.streamingText }}<span class="cursor">|</span></p>
          </div>
        </article>
      </div>
    </section>
...
const modes: Array<{ value: ChatMode; label: string; hint: string }> = [
  ...
  { value: 'multi_agent', label: '多智能体', hint: '数据、政策、风险三个智能体协同完成复杂查询。' },
